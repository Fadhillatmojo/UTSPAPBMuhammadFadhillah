...
import com.example.utspapbmuhammadfadhillah.databinding.ActivityDetail4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            btnGetTicket.setOnClickListener(){
                ...
                val intentToPaymentMethodActivity = Intent(this@DetailActivity4, PaymentMethodActivity::class.java)
                intentToPaymentMethodActivity.type = "image/*" // Set the type of data to image
                intentToPaymentMethodActivity.putExtra("EXT_IMAGE", R.drawable.details3)
